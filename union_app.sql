...
insert  into `category`(`category_id`,`category_name`,`active`,`created_date`,`created_by`,`updated_date`,`updated_by`) values ('6ea864cea181464296e253c89b0ea603','Clothes',1,'2015-12-16','admin','2015-12-20','admin'),('ae96da2da86b4ae680d19ed4e676a392','Food',1,'2015-12-16','admin','2015-12-17','admin'),('dad095775d0b41c993f6df3b3ccd4195','Electronic',1,'2015-12-16','admin','2015-12-20','admin');
...
insert  into `goods`(`goods_id`,`goods_code`,`goods_name`,`brand`,`active`,`created_date`,`created_by`,`updated_date`,`updated_by`) values ('babba2a84a59424498b8da10000b1018','TS','Test Product','yyyy',1,'2015-12-20','admin','2015-12-20','admin');
...
insert  into `goods_category`(`goods_id`,`category_id`) values ('babba2a84a59424498b8da10000b1018','dad095775d0b41c993f6df3b3ccd4195');
...
insert  into `goods_supplier`(`supplier_id`,`goods_id`) values ('6675a18f22234b12b54e42bd25c19eb0','babba2a84a59424498b8da10000b1018');
...
insert  into `supplier`(`supplier_id`,`supplier_name`,`pic`,`address`,`active`,`created_date`,`created_by`,`updated_date`,`updated_by`) values ('04a0b495fc8e4e4aa77a7f06d2d43b2b','supplier name 2x','mr.yc','lonely street on the boulevard of broken dream 2-2y',0,'2015-12-18','admin','2015-12-20','admin'),('5c9fca38d19241ee9713b3718c9fa8af','supplier name 9','miss.h','wet slippy road',1,'2015-12-18','admin','2015-12-20','admin'),('6675a18f22234b12b54e42bd25c19eb0','supplier name 5','miss.h','wet slippy road',1,'2015-12-18','admin','2015-12-20','admin'),('73b304bc3f254614b804eb5c8e032caf','gg','ggg','gggg',1,'2015-12-18','admin',NULL,NULL),('7fdf8786258d468ea14acb2b654c9ba2','supplier name 4','miss.v','wet slippy',1,'2015-12-18','admin','2015-12-20','admin');
