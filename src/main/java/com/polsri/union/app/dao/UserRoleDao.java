...
public class UserRoleDao {
	...
	private static final String FIND_USER_BY_ROLE = "SELECT * FROM user a,user_role b WHERE a.user_id=b.user_id AND b.role_id=? ";
	private static final String FIND_ROLE_BY_USER = "SELECT * FROM role a,user_role b WHERE a.role_id=b.role_id AND b.user_id=?";
	private static final String DELETE_BY_USER_OR_ROLE = "DELETE FROM user_role  WHERE user_id = ? or role_id = ? ";
